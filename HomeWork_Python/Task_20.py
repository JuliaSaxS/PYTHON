...
N = abs(int(input('If the word is in English, enter 0. If the word is in Russian, enter 1: ')))
word = input('Enter the word: ').upper()
if N == 0:
	print('The cost of this word', sum([k for i in word for k, v in eng.items() if i in v]), 'points.')
elif N == 1:
